...
export default async function CoursePage(props: ProductPageProps) {
  ...
  return (
    <>
      <UsersLayout>
        <div className="relative lg:justify-center mt-5 lg:ml-12 p-10 lg:grid grid-cols-3">
          {course.data.length > 0 &&
            course.data.map((course: any) => (
              <Link href={`/Course/${course.category}`}>
                <div className="max-w-sm bg-white/15 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mr-2 mt-5">
